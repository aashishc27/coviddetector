...
import bluetooth.BackgroundWorker
...
//                (isBluetoothPermissionAvailable(com.example.coviddetector.background.CoronaApplication.instance))
//            registerationData.isLocAllowed =
//                isLocationPermissionAvailable(com.example.coviddetector.background.CoronaApplication.instance)
//            registerationData.isBlOn = isBluetoothAvailable()
//            registerationData.isLocOn = isLocationOn(com.example.coviddetector.background.CoronaApplication.instance)
//
//            val eventName =
...
//
//
//                override fun onResponse(call: android.telecom.Call<JsonElement>, response: Response<JsonElement>) {
//                    if (response.isSuccessful && response.body() != null) {
//                        parseResponse(response, listener)
//                        if (!SharedPref.getStringParams(
//                                com.example.coviddetector.background.CoronaApplication.instance,
...
//            val intent = HomeActivity.getLaunchIntent(url, title, context)
//            if (isNewTask) {
...
//        }
        ...
        fun remove30DaysOldData() {
            val dbInstance = FightCovidDB.getInstance()
